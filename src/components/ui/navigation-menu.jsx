...
function NavigationMenuTrigger({ className, children, ...props }) {
   return (
      ...
      >
         {children}{" "}
         <ChevronDownIcon
            className="relative ml-2 top-[1px] size-4 transition duration-300 group-data-[state=open]:rotate-180"
            aria-hidden="true"
         />
      </NavigationMenuPrimitive.Trigger>
   );
...
function NavigationMenuIndicator({ className, ...props }) {
   return (
      <NavigationMenuPrimitive.Indicator
         ...
         {...props}
      >
         <div className="bg- relative top-[60%] h-2 w-2 rotate-45 rounded-tl-sm shadow-md" />
      </NavigationMenuPrimitive.Indicator>
   );
}
