        ...
        >
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center relative z-10">
            ...
            <div
              ...
              data-aos-delay="500"
            >
              <h1 className="absolute -right-2.5 -bottom-64 z-2 lg:text-right font-bold text-[50px] md:text-[450px] opacity-100! text-white/50">
                ?
              </h1>
              <h1 className="absolute right-40 -bottom-72 z-10 lg:text-right font-bold text-[50px] md:text-[390px] opacity-100! text-white/50">
                ?
              </h1>
